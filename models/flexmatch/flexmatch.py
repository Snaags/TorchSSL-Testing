...
class FlexMatch:
    ...
    def train(self, args, logger=None, lb_eval= None,teacher = None):
    ...
    def retrain(self, args,teacher,logger=None,lb_eval = None ):
        ...
        for (_, x_lb, y_lb), (x_ulb_idx, x_ulb_w, x_ulb_s) in zip(self.loader_dict['train_lb'],
            ...
            with amp_cm():
                ...
                total_loss = sup_loss +  (self.lambda_teacher) * teacher_loss + (1-self.lambda_teacher) * ( self.lambda_u * unsup_loss )
                if self.it % 10 == 0:
                    print("[Losses] superv : {} -- unsup_loss: {} -- teacher : {} -- Total: {}".format(sup_loss,unsup_loss,teacher_loss, total_loss))
